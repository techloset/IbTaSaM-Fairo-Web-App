  ...
  return (
    <>
      ...
      <div className="max-w-[1320px] mx-auto px-7">
        ...
        <div className="w-full md:w-[640px] h-[52px] mx-auto bg-white border border-_grayborder md:flex items-center my-8 hidden">
          <input
            type="text"
            placeholder="Enter invitation link"
            className="text-_grayColor text-[14px] font-[400] leading-[21px] outline-none w-[100%] ml-4"
          />
        </div>
        ...
        <div className="w-[388px] md:w-[640px] h-[52px] mx-auto py-3.5 bg-_greenColor justify-center items-center hidden md:block">
          <Link
            href="/profile"
            className="flex justify-center text-_lightGreenColor text-[16px] font-[400] leading-[24px]"
          >
            Log in
          </Link>
        </div>
        <div className="text-center my-8 text-_grayColor text-[14px] font-[400] leading-[21px]">
          Or proceed with
        </div>
        ...
        <div className="w-full md:w-[640px] md:h-[52px] mx-auto grid md:grid-cols-2 md:gap-5 space-y-3 md:space-y-0 pt-5 md:pt-0">
          <button className="md:w-[304px] h-16 px-[97px] py-4 bg-white border border-_grayborder flex-col justify-center items-center gap-2.5 inline-flex">
            <div className="justify-center items-center gap-3 inline-flex">
              ...
              <div className="text-center text-_blackColor text-[14px] font-[400]  leading-[21px]">
                Metamask
              </div>
            </div>
          </button>
